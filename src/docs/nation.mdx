...
slug: /nation
title: Nation guide
description: A nation costs 1024 gold on Terra Nova and 2048 gold on Terra Aurora. Deposit at least 1024/2048 to the town bank using /t deposit 1024/2048. Only a mayor of a town can create a nation. The mayor's town will become the nation's capital. Create the nation with /n new.
sidebar_position: 8
...
Make sure your nation's name complies with the [nation naming rules](https://earthmc.net/docs/rules/#21-naming). It has to have the same name as a real current or past nation. Read the rules page for more information.
